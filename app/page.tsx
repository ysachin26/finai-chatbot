...
import { Globe, MessageSquare, Wallet, BookOpen, Shield, Zap } from "lucide-react"
      ...
      <section className="relative cosmic-bg text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">Your Multilingual Financial Assistant Powered by Groq & Stellar</p>
            <p className="text-lg mb-10 text-indigo-100">
              Access financial services, manage your blockchain wallet, and improve your financial literacy in your
              preferred language.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="overflow-hidden border-t-4 border-t-indigo-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              <CardHeader className="bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-indigo-950/50 transition-colors duration-300 group-hover:from-indigo-50 group-hover:to-indigo-100 dark:group-hover:from-indigo-950/50 dark:group-hover:to-indigo-900/50">
                ...
                <CardDescription>Communicate in your preferred language</CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Our AI assistant understands and responds in multiple languages, making financial services accessible
            ...
            <Card className="overflow-hidden border-t-4 border-t-blue-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              <CardHeader className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-blue-950/50 transition-colors duration-300 group-hover:from-blue-50 group-hover:to-blue-100 dark:group-hover:from-blue-950/50 dark:group-hover:to-blue-900/50">
                ...
                <CardDescription>Secure transactions via Stellar</CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Create a wallet, send/receive funds, and check your balance using the secure Stellar blockchain
                  network for fast and low-cost transactions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden border-t-4 border-t-indigo-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              <CardHeader className="bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-indigo-950/50 transition-colors duration-300 group-hover:from-indigo-50 group-hover:to-indigo-100 dark:group-hover:from-indigo-950/50 dark:group-hover:to-indigo-900/50">
                ...
                <CardDescription>Fast and context-aware responses</CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Get instant help with financial questions, transaction guidance, and personalized advice powered by
                  Groq's advanced AI technology.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden border-t-4 border-t-blue-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              ...
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Access structured learning paths, financial tips, and educational resources to improve your financial
            ...
            <Card className="overflow-hidden border-t-4 border-t-indigo-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              ...
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Our intelligent system analyzes transactions for suspicious patterns, protecting you from fraud and
            ...
            <Card className="overflow-hidden border-t-4 border-t-blue-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group">
              ...
              <CardContent className="pt-4">
                <p className="text-slate-600 dark:text-slate-300">
                  Use voice commands and dictation to interact with the assistant, making it accessible for users who
      ...
      <section className="py-16 cosmic-bg text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join FinAI today and experience the future of financial assistance, powered by Groq AI and Stellar
            blockchain.
          </p>
          <Link href="/chat">
            <Button
